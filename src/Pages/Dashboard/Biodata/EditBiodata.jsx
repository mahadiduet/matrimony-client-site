            ...
            {bioData?
                <>
                    <div className="max-w-md mx-auto p-6 bg-white rounded-md shadow-md">
                        <h2 className="text-xl font-semibold mb-4">Biodata Updated Form</h2>
                        <form onSubmit={handleEditBiodata}>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="name" name="name" defaultValue={bioData[0].name} className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="profile-image" className="block font-semibold mb-2">Profile Image Link</label>
                                <input type="text" id="profile-image" name="profile_image" defaultValue={bioData[0].profile_image} className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="date-of-birth" className="block font-semibold mb-2">Date of Birth</label>
                                <input type="date" id="date-of-birth" name="date_of_birth" defaultValue={bioData[0].date_of_birth} className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="height" className="block font-semibold mb-2">Height</label>
                                <select id="height" name="height" defaultValue={bioData[0].height} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <select id="weight" name="weight" defaultValue={bioData[0].weight} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input type="number" id="age" name="age" defaultValue={bioData[0].age} className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="occupation" className="block font-semibold mb-2">Occupation</label>
                                <select id="occupation" name="occupation" defaultValue={bioData[0].occupation} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <select id="race" name="race" defaultValue={bioData[0].race} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="father_name" defaultValue={bioData[0].father_name} name="father_name" className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="mother-name" className="block font-semibold mb-2">Mother's Name</label>
                                <input type="text" id="mother-name" name="mother_name" defaultValue={bioData[0].mother_name} className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="permanent-division" className="block font-semibold mb-2">Permanent Division</label>
                                <select id="permanent-division" name="permanent_division" defaultValue={bioData[0].permanent_division} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <select id="present-division" name="present_division" defaultValue={bioData[0].present_division} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input type="number" id="expected-partner-age" defaultValue={bioData[0].expected_partner_age} name="expected_partner_age" className="w-full border rounded-md px-3 py-2" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="expected-partner-height" className="block font-semibold mb-2">Expected Partner Height</label>
                                <select id="expected-partner-height" name="expected_partner_height" defaultValue={bioData[0].expected_partner_height} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <select id="expected-partner-weight" name="expected_partner_weight" defaultValue={bioData[0].expected_partner_weight} className="w-full border rounded-md px-3 py-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input type="email" id="contact-email" name="contact_email" defaultValue={bioData[0].contact_email} className="w-full border rounded-md px-3 py-2" readOnly />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="mobile-number" className="block font-semibold mb-2">Mobile Number</label>
                                <input type="tel" id="mobile-number" name="mobile_number" defaultValue={bioData[0].mobile_number} className="w-full border rounded-md px-3 py-2" required />
                            </div>
                ...
                <div className="text-3xl font-extrabold text-red-500 w-1/2 mx-auto mt-20">
                    There is no available bio data. Please create your Bio Data.
                </div>
            }
        </div>
    );
